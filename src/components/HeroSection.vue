<template>
  <section class="relative w-full" data-aos="zoom-in-up">
    ...
    >
      ...
      >
        <div class="lg:py-6">
          <div class="font-lao text-center lg:text-left">
            <h1
        ...
        <div class="lg:h-full md:flex">
          ...
          >
            ...
            ></div>
            <div
              class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 md:items-center rounded-full shadow-lg border border-primary"
            >
              <img
                src="@/assets/Bo_1.jpg"
                alt="Hero pic"
