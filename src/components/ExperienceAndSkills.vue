  ...
  <section class="text-white mt-18" id="skills">
    ...
    >
      <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full w-[80%]">
        <h2 class="font-lao text-4xl font-bold text-white text-left mb-4">
          {{ $t('my') }}
          <span
            class="font-lao text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary"
            >{{ $t('skills') }}</span
          >
        </h2>
      ...
      <div data-aos="flip-left">
        <h2
          class="font-lao text-4xl font-bold text-white text-left mb-8 md:text-center md:mt-0 mt-8"
        >
          {{ $t("experiences") }}
        </h2>
